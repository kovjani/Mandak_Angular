...
/***/ "./typescript/frontend/main/audio_player.ts":
/*!**************************************************!*\
  !*** ./typescript/frontend/main/audio_player.ts ***!
  \**************************************************/
...
function PlayAudio(music, music_index) {
    (0, jquery_1.default)('#pauseButton').click();
    (0, jquery_1.default)("#audio_player").attr("src", music.getMusicAudio());
    (0, jquery_1.default)('#playButton').click();
    if (music.getMusicAuthor() !== "") {
        (0, jquery_1.default)("#audio_title").text(music.getMusicAuthor() + ": " + music.getMusicTitle());
    }
    else {
...
/***/ "./typescript/frontend/main/main.ts":
/*!******************************************!*\
  !*** ./typescript/frontend/main/main.ts ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
(0, jquery_1.default)(function () {
    ...
    var seekBar = (0, jquery_1.default)('#seekBar');
    var currentTimeDisplay = (0, jquery_1.default)('#currentTime');
    var durationDisplay = (0, jquery_1.default)('#duration');
    (0, jquery_1.default)('#playButton').click(function () {
        audio.play();
        (0, jquery_1.default)('#playButton').hide();
        (0, jquery_1.default)('#pauseButton').show();
    });
    (0, jquery_1.default)('#pauseButton').click(function () {
        audio.pause();
        (0, jquery_1.default)('#pauseButton').hide();
        (0, jquery_1.default)('#playButton').show();
    });
    ...
    audio.ontimeupdate = function () {
        ...
        var currentSecondsStr = currentSeconds.toString();
    ...
    audio.onloadedmetadata = function () {
        ...
        var totalSecondsStr = totalSeconds.toString();
        if (totalSeconds < 10) {
            totalSecondsStr = '0' + totalSeconds;
        }
    ...
    seekBar.on('input', function () {
        var val = seekBar.val();
        var seek_bar_val = typeof val === 'string' ? Number(val) : 0;
        var time = audio.duration * (seek_bar_val / 100);
        audio.currentTime = time;
    });
    (0, jquery_1.default)("#repertoire_search_btn").click(function () {
        var val = (0, jquery_1.default)("#repertoire_search_item").val();
...
var lastScrollTop = 0;
var search_bar_hidden = false;
(0, jquery_1.default)(document).on('scroll', function (e) {
    var st = (0, jquery_1.default)(document).scrollTop();
    if (st !== undefined) {
        if (st > lastScrollTop && !search_bar_hidden) {
            // Hide search_bar on downscroll.
            search_bar_hidden = true;
            (0, jquery_1.default)(".search_bar_container_outside").stop(true, true).animate({
                top: '-5em'
            });
        }
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.RepertoireSearch = RepertoireSearch;
var jquery_1 = __importDefault(__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"));
var Music_1 = __webpack_require__(/*! ../../models/Music */ "./typescript/models/Music.ts");
var Event_1 = __webpack_require__(/*! ../../models/Event */ "./typescript/models/Event.ts");
var audio_player_1 = __webpack_require__(/*! ../main/audio_player */ "./typescript/frontend/main/audio_player.ts");
function RepertoireSearch(item) {
    jquery_1.default.post("repertoire_data", { search_item: item }, function (repertoire_result) {
        ...
        if (repertoire_result.length == 0) {
            var list_item = (0, jquery_1.default)("<div id='no_result_container'></div>");
            list_item.addClass("d-lg-flex");
            list_item.addClass("justify-content-lg-between");
            list_item.addClass("align-items-lg-center");
            var no_result = (0, jquery_1.default)("<p id='no_result'></p>").text("A keresésnek nincsen eredménye.");
...
var Music = /** @class */ (function () {
    ...
    function Music(music_id, music_title, music_event, music_author) {
        this.music_author = "";
        ...
        if (music_author) {
            ...
            this.music_audio = "/events/".concat(music_event.getEventFolder(), "/audio/").concat(music_author, "_").concat(music_title, ".mp3");
        }
        else {
            this.music_audio = "/events/".concat(music_event.getEventFolder(), "/audio/").concat(music_title, ".mp3");
        }
    }
    Music.prototype.getMusicId = function () {
        return this.music_id;
    };
    Music.prototype.getMusicTitle = function () {
        return this.music_title;
    };
    Music.prototype.getMusicAuthor = function () {
        return this.music_author;
    };
    Music.prototype.getMusicAudio = function () {
        return this.music_audio;
    };
    Music.prototype.getMusicEvent = function () {
        return this.music_event;
    };
    Music.prototype.getMusicEventPlace = function () {
        return this.music_event.getEventPlace();
    };
    Music.prototype.getMusicEventDate = function () {
        return this.music_event.getEventDate();
    };
    Music.prototype.getMusicEventDateStr = function () {
        return this.music_event.getEventDateStr();
    };
    Music.prototype.getMusicEventFolder = function () {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./typescript/frontend/main/main.ts");
/******/ 	
/******/ })()
;
