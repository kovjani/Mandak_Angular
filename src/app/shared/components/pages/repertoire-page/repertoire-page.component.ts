...
export class RepertoirePageComponent implements OnInit{
    ...
    public PlayMusicList(music_list: Music[], music_index: number): void {
    ...
    private PlayAudio(music: Music, music_index: number){
    ...
    private Search(val: any){
        ...
        this.searchbarService.RepertoireSearch(search_item);
    }
}
